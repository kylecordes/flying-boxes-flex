...
package fly
{
	public class RandomData {
		...
		private static var lastNames:Array = [ "Abrew", "ACKERMAN", "ACTON",
	...
	private static var firstNames:Array = [ "Lisa", "LONNY", "Lorenzo", "LORI",
	...
	private static var streetNames:Array = [ "3rd Street", "5th  & Hunt Street",
		...
		private static function nextInt(n: int): int {
			return Math.floor(Math.random() * n);
		}

		public static function makeName():String {
			return firstNames[nextInt(firstNames.length)] + " "
					+ lastNames[nextInt(lastNames.length)];
		}	

		public static function makeAddress():String {
			return "" + nextInt(10000) + " "
				+ streetNames[nextInt(streetNames.length)];
		}
